// src/components/invitation/RsvpSection.tsx
...
    // Logic Nyata: updateSupabase('rsvp_text', { field: fieldName, content: newContent });
  };
...
              {/* PERBAIKAN KRITIS: Pisahkan Label Visual dari Tag <Label> HTML */}
              <div className="text-gold text-lg">
                <EditableText onSave={handleTextSave('nameLabel')} tagName="span">
                  {editableText.nameLabel}
                </EditableText>
              </div>
              <Label htmlFor="guestName" className="sr-only">Nama Lengkap</Label>
              <Input
                id="guestName"
                {...register("guestName")}
