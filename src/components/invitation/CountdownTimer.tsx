// src/components/invitation/CountdownTimer.tsx (Versi Final & Responsif)
...
// --- Custom Hook useCountdown (Asumsi tetap sama) ---
...
    // ... (logic useCountdown) ...
    ...
    useEffect(() => {
        const interval = setInterval(() => {
            ...
            setTimeLeft({
                days: padToTwoDigits(days), hours: padToTwoDigits(hours),
                minutes: padToTwoDigits(minutes), seconds: padToTwoDigits(seconds),
            });
        }, 1000);
...
// --- Komponen Flip Card Unit (Asumsi tetap sama) ---
...
const FlipCardUnit: React.FC<FlipCardUnitProps> = ({ label, currentValue }) => {
    ...
    const digits = [
        { current: currentD1, prev: prevD2, id: 1 },
...
const DEFAULT_TARGET = "2026-06-25T10:00:00"; 
...
        if (tempDate) {
            // Simpan format TANGGAL + WAKTU standar
