...
import { useAdmin } from '@/context/AdminContext'; // Pastikan path ini benar
...
    // Diasumsikan loginAdmin(password) akan membandingkan password yang diinput 
    // dengan import.meta.env.VITE_ADMIN_PASSWORD
...
// Menghapus penggunaan import.meta.env.DEV agar tombol selalu tampil di Netlify
// =========================================================================
    
// Tombol ini harus selalu di-render agar Admin memiliki kesempatan untuk login
// dengan memasukkan password, baik di mode development maupun production (Netlify).
// Kita tidak lagi menggunakan kondisi if (!alwaysShowToggle) { return null; }
